...
pub fn get(para: HashMap<String, String>) -> Result<String, Error> {
    ...
    for video in list {
        ...
        let achievement = video["achievement"].as_str().unwrap_or_default();
    ...
    let channel = ChannelBuilder::default()
        .title(format!("B站{}", data_title))
        .link("https://www.bilibili.com/v/popular/rank/all")
        .description(data_explain.to_owned())
        .items(item_vec)
        .build();
